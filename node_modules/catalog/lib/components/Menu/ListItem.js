...
var ListItem = function (_React$Component) {
  ...
  _createClass(ListItem, [{
    ...
    value: function render() {
      ...
      var defaultStyle = _extends({}, currentStyle.link);
      if (nested) {
        defaultStyle = _extends({}, defaultStyle, currentStyle.nestedLink);
      }
      return _react2.default.createElement(
        'li',
        null,
        pages ? _react2.default.createElement(_NestedList2.default, _extends({}, this.props, page, { pages: pages })) : _react2.default.createElement(
          _Link2.default,
          {
            style: defaultStyle,
