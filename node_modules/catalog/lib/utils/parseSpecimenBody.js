...
var _jsYamlMin = require('js-yaml/dist/js-yaml.min.js');

var _jsYamlMin2 = _interopRequireDefault(_jsYamlMin);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var yamlOptions = { schema: _jsYamlMin.CORE_SCHEMA };
...
var parseYaml = function parseYaml(str) {
  var parsed = void 0;
  try {
    parsed = _jsYamlMin2.default.safeLoad(str, yamlOptions);
  } catch (e) {
    parsed = void 0;
  }
