...
var reactElementToString = function reactElementToString(el) {
  ...
  var formatProp = function formatProp(k, v) {
    return v === true ? k : typeof v === 'string' ? k + '=\'' + v + '\'' : _react2.default.isValidElement(v) ? k + '={' + reactElementToString(v) + '}' : k + '={' + (JSON.stringify(v) || v.name || (typeof v === 'undefined' ? 'undefined' : _typeof(v))) + '}';
  };
  ...
  var whitespaceBeforeProps = propKeys.length > 1 ? '\n' + indent + '  ' : propKeys.length === 1 ? ' ' : '';
